...
namespace VSSnippetSocket
{
             ...
             size_t stackSendBufferSize)
	{
		...
		settingsStream.AddStringVector("SouthboundInterfaces", {"lo","lo"})
                ...
                .AddString("ManagementBindAddress", "127.0.0.3")
		...
		return runPerf(runtimeInSeconds, dataRateInMbps, payloadSize, *vsLoader.virtualStack, dummyDevice);
	}
}