...
namespace dceCradleSimple
{
    ...
    std::string m_rate = "100Mbps";
    bool m_dual = false;
    std::string m_ccid = "2";
    bool m_bulk = false;

    int main_cradle(int argc, char *argv[])
    {
        ...
        ns3Helper::NS3Helper::setPacketLossRate(nodes.Get(1), 0.01);
...
//    dceManager.SetLoader ("ns3::CoojaLoaderFactory");
        ...
        stack.Install(nodes);
//    stack.SysctlSet(nodes, ".net.ipv4.tcp_congestion_control", "tahoe");
