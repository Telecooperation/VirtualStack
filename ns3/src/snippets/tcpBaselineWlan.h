...
void tcpBaselineWlan()
{
    const std::string simName = "TCPBaselineWlan";
    ...
    NS3Helper::wlan(c.Get(0), c.Get(2), apDevice, staDevices);
...
//    p2p.SetDeviceAttribute("DataRate", StringValue("7.2Mbps"));
...
//    p2p.SetChannelAttribute("Delay", StringValue("10ms"));
    ...
    Ptr<OutputStreamWrapper> routingStream = Create<OutputStreamWrapper> ("sim/" + simName + ".routes", std::ios::out);
