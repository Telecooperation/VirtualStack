...
namespace tcpBaselineLTE_WLAN {

    const std::string simName = "tcpBaselineLteWlan";
...
//        NetDeviceContainer d0d2 = p2p.Install(nodes.Get(0), nodes.Get(2));
        ...
        NS3Helper::wlan(nodes.Get(0), nodes.Get(2), apDevice, staDevices);
...
//        Ipv4InterfaceContainer i0i2 = ipv4.Assign(d0d2);
        Ipv4InterfaceContainer iWifiAp = ipv4.Assign(apDevice);
        Ipv4InterfaceContainer iWifiSta = ipv4.Assign(staDevices);
...
//        std::cout << "i0i2: " << i0i2.GetAddress(0) << ", " << i0i2.GetAddress(1) << std::endl;
        std::cout << "iWifiAp: " << iWifiAp.GetAddress(0) << std::endl;
        std::cout << "iWifiSta: " << iWifiSta.GetAddress(0) << std::endl;
        ...
        NS3Helper::addLteRoutes(nodes, ueDeviceNode, lteGateway_gatewayPartner, true);
