...
namespace tcpBaselineLTE {

    const std::string simName = "tcpBaselineLte";
    ...
    void tcpBaselineLte() {
        ...
        auto netAnim = dumpNetAnim(nodes, lteGateway->GetNode(), simName, enbNodes);
        ...
        flowmonHelper.SerializeToXmlFile(simName + ".flowmon", false, false);
